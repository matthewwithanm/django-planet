...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('planet_feed', ['url'])

        # Removing unique constraint on 'Post', fields ['feed', 'guid']
        db.delete_unique('planet_post', ['feed_id', 'guid'])

        # Changing field 'Feed.url'
        db.alter_column('planet_feed', 'url', self.gf('django.db.models.fields.URLField')(max_length=300))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feed.url'
        db.alter_column('planet_feed', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True))

        # Adding unique constraint on 'Feed', fields ['url']
        db.create_unique('planet_feed', ['url'])
    ...
    models = {
        ...
        'planet.post': {
            'Meta': {'ordering': "('-date_created', '-date_modified')", 'object_name': 'Post'},
